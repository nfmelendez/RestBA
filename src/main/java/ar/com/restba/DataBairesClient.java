 ...
 */
public class DataBairesClient extends BaseDataBairesClient implements FacebookClient {
  /**
   ...
   */
  public DataBairesClient(String accessToken, WebRequestor webRequestor, JsonMapper jsonMapper) {
    super();
